...
from app.services.pdf.builders.cycle_report_builder import build_cycle_report_pdf
...
def generate_cycle_report_pdf(data, charts=None):
    register_fonts()
    return build_cycle_report_pdf(data, charts)